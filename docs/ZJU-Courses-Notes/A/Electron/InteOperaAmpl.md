...
换句话说, **在线性区域工作时, 满足虚短和虚断的两大特性** (虚断是因为 $r_i\rightarrow \infty$, 所以都可用; 但是使用虚短的前提是差分输入情况下 $u_i=u_{i+}-u_{i-}\approx0$ (即在 $A_0\rightarrow \infty$ 时为了保证 $u_o$ 与 $u_i$ 成线性关系, 必须满足 $u_+\approx u_-$) 因此**未在线性工作区就不能用虚短**)
...
![](https://pan.xxbyq.net/f/rJgsg/%E6%88%AA%E5%B1%8F2025-11-29%2015.03.32.png)

![](https://pan.xxbyq.net/f/eAWFG/%E6%88%AA%E5%B1%8F2025-11-29%2015.04.43.png)
...
![](https://pan.xxbyq.net/f/OOJta/%E6%88%AA%E5%B1%8F2025-11-29%2015.47.21.png)
...
![](https://pan.xxbyq.net/f/QBefL/%E6%88%AA%E5%B1%8F2025-11-29%2016.06.58.png)
...
![](https://pan.xxbyq.net/f/BkYt6/%E6%88%AA%E5%B1%8F2025-11-29%2016.13.00.png)
...
![](https://pan.xxbyq.net/f/0NRhm/%E6%88%AA%E5%B1%8F2025-11-29%2016.34.18.png)

![](https://pan.xxbyq.net/f/pbacV/%E6%88%AA%E5%B1%8F2025-11-29%2016.35.17.png)

开环比较器本身结构和原理相当简单, 只需注意稳压二极管可以限制输出电压维持在某一水平, 避免烧毁接入 $u_o$ 的电路.

### 滞回比较器

![](https://pan.xxbyq.net/f/XNvfx/%E6%88%AA%E5%B1%8F2025-11-29%2016.44.38.png)
...
为了作出上面描述的 $u_I-u_O$ 关系图, 我们先设 $u_O$ 正饱和值为 $u_{OH}$, 负饱和值为 $u_{OL}$, 让 $u_I$ 从 $-\infty$ 变化到 $+\infty$, 再让 $u_I$ 从 $+\infty$ 变化到 $-\infty$:

![](https://pan.xxbyq.net/f/GVYFy/d-46.jpg)
...
分析下图中 $u_{o1}$ 和 $u_{o2}$ 的波形.

![](https://pan.xxbyq.net/f/MrMh1/%E6%88%AA%E5%B1%8F2025-11-29%2019.01.22.png)
...
![](https://pan.xxbyq.net/f/PQDFy/%E6%88%AA%E5%B1%8F2025-11-29%2019.22.46.png)

对于转折值 $\frac{R_2}{R_1}U_Z$, 我们只需考虑 $u_{o2}$ 到 $U_Z$ 这一支路的分压关系.因为虚断, 因此 $u_+$ 处不分流.再计算电流, 进一步计算分压, 即可确定 $u_+$ 处关于 $u_{o2}$ 的关系:

$$
u_+=IR_1+U_Z=\frac{u_{o2}-U_Z}{R_1+R_2}R_1+U_Z=\frac{R_2}{R_1+R_2}U_Z+\frac{R_1}{R_1+R_2}u_{o2}
$$

令 $u_+=0$, 考虑正饱和($U_Z$)与负饱和($-U_Z$)两种情况, 即可求得转折点 $-\frac{R_2}{R_1}U_Z$ 与 $\frac{R_2}{R_1}U_Z$.
...
![](https://pan.xxbyq.net/f/oVpi1/98FFDFF7-9142-414D-A455-0046760E3003-95450-0000338C005316E0.PNG)
...
对 $u_{o2}$ 与 $u_{I3}$ 建立联系, 发现 $R_7\gg R_6$, 因此可以将 $R_7$ 视作开路, $u_{I3}=\frac{R_6}{R_5+R_6}(u_{o}-0)=\frac{R_6}{R_5+R_6}u_{o}$.
