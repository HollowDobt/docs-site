...
!!! abstract "Abstract"
	这篇文档除了书本上的相关知识, 还有大量的补充和实践代码, 对人工智能真的感兴趣的同学可以仔细阅读. 对于期末考试, 个人认为主要看看历年卷记忆相关公式即可. 如果你想考非常高的分数, 需要掌握各种各样的边角料知识, 个人认为不太值得.
...
线性回归模型是最简单的监督学习模型. 其核心是使误差最小化. 其具体计算原理是将误差的平方和 $\sum_{i=1}^{n}e_i^2=\sum_{i=1}^{n}(y_i-(ax_i+b))^2$ 最小化. 如何最小化呢? 求偏导确定零点, 解这个方程
