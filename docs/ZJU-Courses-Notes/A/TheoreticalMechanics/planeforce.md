...
![](https://pan.xxbyq.net/f/8kQck/%E8%A1%A5%E5%A4%A9-23.jpg)
...
![](https://pan.xxbyq.net/f/N8Euy/%E6%88%AA%E5%B1%8F2025-11-27%2010.21.25.png)

!!! note
	与上一问差不多, 这里不给出具体计算. 另外, 第(2)问中直接默认 $C$ 处钉销只受到竖直方向的力, 是因为 $BC$ 处保持受力平衡必须满足 $C$ 不给 $x$ 方向的力. 将 $P$ 视作作用在 $C$ 上对求解没有影响, 只是这样会让方程变得更复杂(将 $P$ 视作作用在 $C$ 处钉销后, 分析 $BC$ 部分时 $P$ 的作用自然包含在了 $C$ 对 $BC$ 的作用中)

![](https://pan.xxbyq.net/f/MNMS1/%E8%A1%A5%E5%A4%A9-24.jpg)

### ex4

已知: $P$, $AD＝DB＝a$, $AC＝d$, 半径 $R$. 求: $A$, $C$ 处的约束反力.

![](https://pan.xxbyq.net/f/PPDIy/%E6%88%AA%E5%B1%8F2025-11-27%2011.06.29.png)

![](https://pan.xxbyq.net/f/EQrTz/%E8%A1%A5%E5%A4%A9-25.jpg)
