...
![](https://bed.hlwdot.com/d/SJp0no9R2sIfCKH9zq1cjcjr2fqmeKXw)

- $\sigma_b$: 抗拉强度, 即即将断裂前所能支撑的强度, 也是材料能承受的最大强度(BREAKING)
- $\sigma_s$: 屈服强度, 即让材料保持在弹性形变的最大强度, 可以诙谐为*奴隶(SLAVE)*
- $\sigma_e$: 弹性极限, 即让材料保持弹性形变的同时保持应力与应变成正比关系的最大强度, 因为有 $e$ 可以联想到公式 $\sigma=E\varepsilon$
...
- **晶粒的细化的结果** (强得可怕!!!! 两个都能做到!!!) 晶粒越细小, 那么晶界面积就越大(晶粒与晶粒之间的接触面积越多), 而晶界会阻碍滑移, 因此强度和硬度会上升; 而变形也能因为晶界面积增大分散得更快, 事实上也提升了塑性和韧性.
...
- 点缺陷是形成固溶体的必要物理基础
- **固溶强化** 塑性韧性降低, 强度硬度提升. 产生此种强化的原理是溶质原子使得晶格发生畸变及对位错的钉扎作用.
...
晶粒发生塑性形变, 如果周围晶粒不同时发生塑性形变, 那么就需要发生弹性形变来协调. 这提高了多晶体的抗塑性形变能力.

### 加工硬化

**不是热处理**, 是通过冷塑性变形量的增加(**金属冷加工**)来提高金属的强度和硬度. 同时塑性和韧性随之下降.
...
- **再结晶** *再结晶退火*对应的就是这个退火, 因此就温度上而言就是比去应力退火稍微高一些的地方
- **晶粒长大** 其他几种退火模式, 一般都是为了提高韧性和塑性改善切削加工性能牺牲一些加工硬化得到的强度.

最重要的一个*公式*: $T_再=0.4T_熔$. **单位是开尔文!!!**

### 影响再结晶退火后晶粒度的因素

- 加热温度, 保温时间, 预先变形度. 从退火的分类标准来看, 不难看出温度对晶粒度的影响远超时间.
...
核心是确认单一物质所在的竖线, 并且应当根据 $2.11\%$ 分出钢和铸铁的界. 夹在两个竖线中间的区域的成分必定就是两个竖线的成分, 反之亦然.
...
- **奥氏体** 和其他铁的晶体结构不同, 是*面心立方*, 溶碳能力强, 最大(共晶反应温度 $1148$)可达 $2.11\%$. 碳钢的室温组织中不存在奥氏体
...
- $Si$, $Mn$ 听起来就很硬的元素一般对碳钢都是有益处的
- $P$, $S$ 听起来就很软的元素一般对碳钢都是有害的
...
!!! note
	...
	(2) **30~50: 碳素调质钢**  此种钢平平无奇(所以处于中间, 此即中庸之道~), 但也正是如此其综合力学性能潜力最强, 常常使用调质, 也就是淬火+高温回火的方式来强化其综合力学性能.
...
> 这部分的内容只需要能够根据牌号区分每种铸铁大概知道其性能特点即可

| 名字  | 灰铸铁            | 球墨铸铁           | 可锻铸铁                                   | 蠕墨铸铁            |
| --- | -------------- | -------------- | -------------------------------------- | --------------- |
| 牌号  | $\text{HT100}$ | $\text{QT450}$ | $\text{KTH300-06}$, $\text{KTZ550-04}$ | $\text{RuT260}$ |
| 性能  | 铸造性能好, 力学性能差   | 石墨是球状的, 力学性能最好 | **名为可锻, 实则不可锻造(因为具有较高的塑性)**            | 耐热性好            |
...
!!! note
	什么叫做"过冷奥氏体"呢? 为什么要研究过冷奥氏体呢? C 曲线如何理解呢?
	
	首先, 过冷奥氏体就是指因为冷却速度较快导致即使到了 $A_{c3}$, $A_{cm}$ 时仍然没有来得及转变为其他组织, 此时这个不稳定的组织就叫做过冷奥氏体.
	
	后面两个问题可以合在一起讲. 过冷奥氏体是所有热处理工艺的基石, 后面讲的四把火等等都是在这个基础上建立的. 而过冷奥氏体带来的最重要的图像 $C$ 曲线, 可以在等温条件下根据时间和温度精准确定当前时刻金属的组织类型, 这极大地方便了工业上特定性能钢的生产.

- **孕育期** 指的是转变开始线与纵坐标轴之间的距离. 孕育期的最小值位于 C 曲线的鼻尖处.
- **上贝氏体** 是一种废品, 呈现羽毛状(下贝氏体则相对地呈现为黑针状).
- **下贝氏体** 和上贝氏体相反, 是一种综合力学性能优秀的金属, 生产中常用作强化组织.
- **马氏体** 根据含碳量分为两类, 含碳量低于 0.2% 时为板条状马氏体, 含碳量高于 1.0% 时为针状马氏体(可以这么思考, 碳含量越高那么位错越严重越难形成大块晶粒(也就是固溶强化)). 马氏体转变同样是强化钢的重要途径之一
- 马氏体本质上也是 $\alpha-Fe$, 和铁素体, 珠光体, 莱氏体的相组成是一样的. 区别是, 这一组织的产生源自于快速冷却让碳来不及溶出, 所以在通过缓慢冷却得到的铁碳相图上找不到这种组织.
...
- **再结晶退火** 从这里开始都会消除加工硬化的影响, 甚至直接降低硬度和强度
- **球化退火** 针对**高碳钢(过共析钢)**的. 会将渗碳体球状化. **对于此退火必须知道的知识点: 对于有网状二次渗碳体的过共析钢, 球化退火前必须要做正火处理以消除网状渗碳体(因为正火的处理速度很快, 来不及结成网)**
- **完全退火** 针对**低碳钢(亚共析钢)**的. 名为"完全"是因为会恰好完全转化为奥氏体
...
> 
> 不是哦, 等温淬火的目的就是获得(下)贝氏体组织!


| 淬火类型 | 单液淬火      | 双液淬火      | 分级淬火  | 等温淬火     |
| ---- | --------- | --------- | ----- | -------- |
| 特点   | 操作简单方便自动化 | 效果理想但是难操作 | 减少内应力 | 获得下贝氏体组织 |

!!! note
	影响淬透性的因素:
	
	(1) 总的来说, 过冷奥氏体越稳定, 淬透性越好;
	
	(2) 而我们知道, 共析钢的过冷奥氏体稳定性是最好的(C 曲线), 因此共析钢的淬透性最好;
	
	(3) 合金元素也能提高淬透性, 但是原因同样是增强了过冷奥氏体的稳定性;
	
	(4) 另外, 奥氏体化温度越高, 保温时间越长, 奥氏体越稳定, 淬透性越好.
...
| 回火类型     | 低温回火                            | 中温回火              | 高温回火         |
| -------- | ------------------------------- | ----------------- | ------------ |
| 最终产物(组织) | 回火马氏体($M_{回}$), 少量残留奥氏体, 颗粒状碳化物 | 回火屈氏体($T_回$)      | 回火索氏体($S_回$) |
| 目的       | 保留高硬度和高耐磨性的同时消除内应力              | 提高弹性, 屈服强度, 提高屈强比 | 获得良好的综合力学性能  |
| 应用       | 高硬度和需要耐磨的各种工具钢等                 | 用于各种弹性元件(如弹簧钢)    | 用于各种结构件      |

另外, 调质 = 淬火 + 高温回火, 可以得到良好的综合力学性能.

### 钢的表面热处理

- 表面淬火: 常用**感应加热**, 频率越高淬硬层深度越浅.
- 渗碳: 提高表面硬度和耐磨性的同时保持心部的韧性.
- 渗碳后的热处理: 淬火 + 低温回火. 因为目标获得坚硬耐磨的表面.
- 渗碳后的热处理的结果: **表层: 回火马氏体 + 颗粒状碳化物 + 少量残留奥氏体**, **心部: 回火马氏体 + 铁素体(低碳)**.
