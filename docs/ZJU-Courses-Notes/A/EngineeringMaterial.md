...
!!! warning
	以下更准确地说是复习资料, 因此没有考虑过初学者阅读的友好性 ก็ʕ•͡ᴥ•ʔ ก้
	
	这份复习资料主要为 2025-2026 学年春学期的工程材料课程准备. 主要来源是马梁老师最后一节复习课.
...
| 常见金属(主要关注铁元素, Cu 和 Al 是后面其他金属章节要求记忆的) | $\alpha-Fe$, $\delta-Fe$                       | $\gamma-Fe$, 各种 $Cu$ 和 $Al$(滑移系大, 所以这些类型的金属可以直觉感觉到塑性很优秀) | -      |
...
和退火本质上是一致的(温度同样在图中, 记住仅次于均匀化退火即可). **但是, 正火的操作更简单, 效率更高, 还可以提高硬度(晶粒细化), 因此也是大量普通件的最终热处理.**
...
- 对奥氏体区的影响: 相似相溶有促进作用. 因此: 面心立方(可塑性强)(Mn, Ni, Cu, C, N)扩大奥氏体区, Cr, Al(很特殊, 是面心立方晶格, 但是是强烈的铁素体形成元素)缩小.
...
杂七杂八的很多, 看看前面常见的几种金属的特性与应用案例对号入座应该就够了. 其他的看老师讲课的视频理解一下就够了.
...
- 淬火 + 低温回火. 这里想提醒的是没说或者没有牌号对应专门的水韧, 表面热处理一类的就别考虑.
