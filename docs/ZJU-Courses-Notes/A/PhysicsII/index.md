...
高中时期我们学习过库伦定律, 其定义下的电场强度可以表示为:

$$
E=k\frac{Q}{r^2}
$$

上述等式仅仅只对真空中的点电荷起作用, 造成这一点的原因是空间中的孤立点电荷电场线分布全都都垂直于以点电荷为球心的球体. 既然如此, 我们不妨构造一个半径为 $r$ 的球体, 并定义 $\phi=\vec E\cdot S$, 即电场强度乘以表面积, 其电场强度可以重新表示为:
